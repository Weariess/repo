...
const [error, setError] = useState(false)
    ...
    return(
        <div>
            ...
            {kraj.cca2 != null && 
            <div><div className="flex flex-col justify-center items-center text-center min-screen">
            <Image src={kraj.flags.png} width={600} height={200} alt={kraj.name.common}></Image>
